...
public:
    ...
    /*
    //取两个字符串之间的字符串
    [[deprecated]] pystring_utf32_class py_between_start_and_end_string(const pystring_utf32_class &str_start,
            const pystring_utf32_class &str_end = U"") const;

    //取两个字符串之间的字符串所在的起始位置和长度
    [[deprecated]] bool py_between_start_and_end_pos(const pystring_utf32_class &str_start,
            const pystring_utf32_class &str_end,
            std::u32string::size_type &n_start,
            std::u32string::size_type &n_copylen) const;
    */
    bool py_get_middle_of_pos(const std::u32string &str_start,
                              const std::u32string &str_end,
                              std::u32string::size_type &n_start,
                              std::u32string::size_type &n_copylen) const;

    //取字符串中两个字符串之间的字符串
    pystring_utf32_class py_get_middle_of(const std::u32string &str_start,
                                          const std::u32string &str_end = U"") const;

    //删除字符串中两个字符串中间的字符串
    pystring_utf32_class py_delete_middle_of(const std::u32string& str_start_flag,
            const std::u32string& str_end_flag,
            long_max_t n_count = MAX_SIGNED_LONG64_NUM) const;

    //截断字符串
    pystring_utf32_class py_truncate(const std::u32string &str_truncate);
    //截断字符串中标志的任意字符
    pystring_utf32_class py_truncate_char32_t(const std::u32string &str_truncate);
    ...
    const std::u32string& to_const_std_u32string() const;

    //返回std::u32string的引用
    //使pystring_utf32_class可以不产生复制的情况下兼容std::u32string接口
    std::u32string& to_quote_std_u32string();

    //返回std::u32string的引用
    //使pystring_utf32_class可以不产生复制的情况下兼容std::u32string接口
    std::u32string& to_reference_std_u32string();
...
public:
    ...
    /*
    //取两个字符串之间的字符串
    [[deprecated]] pystring_ext py_between_start_and_end_string(const std::string &str_start,
            const std::string &str_end = "") const;

    //取两个字符串之间的字符串所在的起始位置和长度
    [[deprecated]] bool py_between_start_and_end_pos(const std::string &str_start,
            const std::string &str_end,
            std::string::size_type &n_start,
            std::string::size_type &n_copylen) const;
    */
    bool py_get_middle_of_pos(const std::string &str_start,
                              const std::string &str_end,
                              std::string::size_type &n_start,
                              std::string::size_type &n_copylen) const;

    //取字符串中两个字符串之间的字符串
    pystring_ext py_get_middle_of(const std::string &str_start,
                                  const std::string &str_end = "") const;

    //删除字符串中两个字符串中间的字符串
    pystring_ext py_delete_middle_of(const std::string& str_start_flag,
                                     const std::string& str_end_flag,
                                     long_max_t n_count = MAX_SIGNED_LONG64_NUM) const;
    //截断字符串
    pystring_ext py_truncate(const std::string &str_truncate);

    //截断字符串中标志的任意字符
    pystring_ext py_truncate_char(const std::string &str_truncate);
    ...
    const std::string& to_const_std_string() const;

    //返回std::string的引用
    //使pystring_ext可以不产生复制的情况下兼容std::string接口
    std::string& to_quote_std_string();
    //返回std::string的引用 to_quote_std_string的别名
    //使pystring_ext可以不产生复制的情况下兼容std::string接口
    std::string& to_reference_std_string();
