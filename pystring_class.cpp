...
{
    return pystring_utf32_function::get_middle_of(var_container,
...
{
    return pystring_utf32_function::get_middle_of_pos(var_container, str_start.var_container,
            str_end.var_container,
            n_start, n_copylen);
}
*/
bool pystring_utf32_class::py_get_middle_of_pos(const std::u32string &str_start,
        const std::u32string &str_end,
        std::u32string::size_type &n_start,
        std::u32string::size_type &n_copylen) const
{
    return pystring_utf32_function::get_middle_of_pos(var_container,
            str_start,
            str_end,
            n_start,
            n_copylen);
...
//取字符串中两个字符串之间的字符串
pystring_utf32_class pystring_utf32_class::py_get_middle_of(const std::u32string &str_start,
        const std::u32string &str_end) const
{
    return pystring_utf32_function::get_middle_of(var_container,str_start,str_end);
}

//删除字符串中两个字符串中间的字符串
pystring_utf32_class pystring_utf32_class::py_delete_middle_of(const std::u32string& str_start_flag,
        const std::u32string& str_end_flag,
        long_max_t n_count) const
{
    return pystring_utf32_function::delete_middle_of(var_container,str_start_flag,str_end_flag,n_count);
}

//截断字符串
pystring_utf32_class pystring_utf32_class::py_truncate(const std::u32string &str_truncate)
{
    return pystring_utf32_function::truncate(var_container,str_truncate);
}

//截断字符串中标志的任意字符
pystring_utf32_class pystring_utf32_class::py_truncate_char32_t(const std::u32string &str_truncate)
{
    return pystring_utf32_function::truncate_char32_t(var_container,str_truncate);
}
...
//to_const_std_u32string返回一个const std::u32string&
//使pystring_utf32_class可以不产生复制的情况下兼容std::u32string接口
const std::u32string& pystring_utf32_class::to_const_std_u32string() const
{
    return (const std::u32string&)var_container;
}

//返回std::u32string的引用
//使pystring_utf32_class可以不产生复制的情况下兼容std::u32string接口
std::u32string& pystring_utf32_class::to_quote_std_u32string()
{
    return (std::u32string&)var_container;
}

//返回std::u32string的引用
//使pystring_utf32_class可以不产生复制的情况下兼容std::u32string接口
std::u32string& pystring_utf32_class::to_reference_std_u32string()
{
    return (std::u32string&)var_container;
}
...
//返回std::u32string的复制
std::u32string pystring_utf32_class::to_std_u32string() const
{
    return (std::u32string)var_container;
}
...
{
    return pystring_function::get_middle_of_pos(var_container, str_start, str_end,
            n_start, n_copylen);
}
*/
bool pystring_ext::py_get_middle_of_pos(const std::string &str_start,
                                        const std::string &str_end,
                                        std::string::size_type &n_start,
                                        std::string::size_type &n_copylen) const
{
...
//取字符串中两个字符串之间的字符串
pystring_ext pystring_ext::py_get_middle_of(const std::string &str_start,
        const std::string &str_end) const
{
    return pystring_function::get_middle_of(var_container,str_start,str_end);
}
...
//删除字符串中两个字符串中间的字符串
pystring_ext pystring_ext::py_delete_middle_of(const std::string& str_start_flag,
        const std::string& str_end_flag,
        long_max_t n_count) const
{
...
//截断字符串
pystring_ext pystring_ext::py_truncate(const std::string &str_truncate)
{
    return pystring_function::truncate(var_container,str_truncate);
}

//截断字符串中标志的任意字符
pystring_ext pystring_ext::py_truncate_char(const std::string &str_truncate)
{
...
//to_const_std_string返回一个const std::string&
//使pystring_ext可以不产生复制的情况下兼容std::string接口
const std::string& pystring_ext::to_const_std_string() const
{
    return (const std::string&)var_container;
}

//返回std::string的引用
//使pystring_ext可以不产生复制的情况下兼容std::string接口
std::string& pystring_ext::to_quote_std_string()
{
    return (std::string&)var_container;
}

//返回std::string的引用
//使pystring_ext可以不产生复制的情况下兼容std::string接口
std::string& pystring_ext::to_reference_std_string()
{
    return (std::string&)var_container;
}
...
//to UTF-16
std::u16string pystring_ext::to_std_u16string() const
{
...
//to UTF-32
std::u32string pystring_ext::to_std_u32string() const
{
