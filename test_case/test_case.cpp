...
void test_string_format_suprintf()
{
    check_equal(string_printf::suprintf("%% %d %f %s", 1, 1.0, "test"), "% 1 1.00 test");
    check_equal(string_printf::suprintf("%2d %08.4f %6s", 1, 1.0, "test"), " 1 001.0000   test");
    check_equal(string_printf::suprintf("%-04d", 1), "1.00");
    check_equal(string_printf::suprintf("std::string : %S", std::string("test")), "std::string : test");
    check_equal(string_printf::suprintf(U"%-04d", 1), U"1.00");
}

void test_string_format_sprintf_class()
{
    check_equal(pystring_ext::sprintf("%% %d %f %s", 1, 1.0, "test"), "% 1 1.00 test");
    check_equal(pystring_ext::sprintf("%2d %08.4f %6s", 1, 1.0, "test"), " 1 001.0000   test");
    check_equal(pystring_ext::sprintf("%-04d", 1), "1.00");
    check_equal(pystring_ext::sprintf("pystring : %S", pystring_ext("test")), "pystring : test");
}

void test_string_format_argv_class()
{
    //test format
...
{
    test_string_format_suprintf();
    test_string_format_sprintf_class();
    test_string_format_argv_class();
}
...
int main()
{
    ...
    std::cout << "wchar_t same as char16_t" << std::endl;
    #endif
    #ifdef WCHAR_IS_UTF32CHAR
    std::cout << "wchar_t same as char32_t" << std::endl;
    #endif

    test_string_format();
    std::cout << "test string format function: pass" << std::endl;
    test_pystring_function();
    std::cout << "test pystring function: pass" << std::endl;
    test_pystring_class();
