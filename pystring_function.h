...
[[deprecated]] bool between_start_and_end_pos(const std::string &str_data,
...
//取两个字符串之间的字符串
[[deprecated]] std::string between_start_and_end_string(const std::string &str_data,
        const std::string &str_start,
        const std::string &str_end = "");
*/
//取两个字符串之间的字符串所在的起始位置和长度
...
std::string delete_middle_of(const std::string& str_input_text,
                             ...
                             const std::string& str_multi_line_note_end_flag,
