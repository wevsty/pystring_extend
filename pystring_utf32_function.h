...
[[deprecated]] bool between_start_and_end_pos(const std::u32string &str_data,
...
//取两个字符串之间的字符串
[[deprecated]] std::u32string between_start_and_end_string(const std::u32string &str_data,
        const std::u32string &str_start,
...
std::u32string delete_middle_of(const std::u32string& str_input_text,
                             ...
                             long_max_t n_count = MAX_SIGNED_LONG64_NUM);
