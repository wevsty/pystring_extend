...
{
	//切片 slice
	check_equal(pystring_utf32::slice(U""), U"");
	check_equal(pystring_utf32::slice(U"", 1), U"");
	check_equal(pystring_utf32::slice(U"", -1), U"");
	check_equal(pystring_utf32::slice(U"", -1, 2), U"");
	check_equal(pystring_utf32::slice(U"abcdef"), U"abcdef");
	check_equal(pystring_utf32::slice(U"abcdef", 0), U"abcdef");
	check_equal(pystring_utf32::slice(U"abcdef", 1), U"bcdef");
	check_equal(pystring_utf32::slice(U"abcdef", 2), U"cdef");
	check_equal(pystring_utf32::slice(U"abcdef", 2, 2), U"");
	check_equal(pystring_utf32::slice(U"abcdef", 2, 3), U"c");
	check_equal(pystring_utf32::slice(U"abcdef", 2, 1), U"");
	check_equal(pystring_utf32::slice(U"abcdef", 2, -1), U"cde");
	check_equal(pystring_utf32::slice(U"abcdef", 2, -2), U"cd");
	check_equal(pystring_utf32::slice(U"abcdef", 2, -3), U"c");
	check_equal(pystring_utf32::slice(U"abcdef", 2, -4), U"");
	check_equal(pystring_utf32::slice(U"abcdef", 2, -5), U"");
	check_equal(pystring_utf32::slice(U"abcdef", -1), U"f");
	check_equal(pystring_utf32::slice(U"abcdef", -2), U"ef");
	check_equal(pystring_utf32::slice(U"abcdef", -99), U"abcdef");
	check_equal(pystring_utf32::slice(U"abcdef", -99, -98), U"");
	check_equal(pystring_utf32::slice(U"abcdef", -2, 3), U"");
	check_equal(pystring_utf32::slice(U"abcdef", -2, 10), U"ef");
	check_equal(pystring_utf32::slice(U"abcdef", -1), U"f");
	check_equal(pystring_utf32::slice(U"abcdef", 0, -1), U"abcde");
	check_equal(pystring_utf32::slice(U"string", -3, -1), U"in");
	//
	//find()
	check_equal(pystring_utf32::find(U"", U""), 0);
	check_equal(pystring_utf32::find(U"", U"a"), -1);
	check_equal(pystring_utf32::find(U"a", U""), 0);
	check_equal(pystring_utf32::find(U"a", U"a"), 0);
	check_equal(pystring_utf32::find(U"abcdef", U""), 0);
	check_equal(pystring_utf32::find(U"abcdef", U"", -1), 5);
	check_equal(pystring_utf32::find(U"abcdef", U"", -2), 4);
	check_equal(pystring_utf32::find(U"abcdef", U"", -5), 1);
	check_equal(pystring_utf32::find(U"abcdef", U"", -6), 0);
	check_equal(pystring_utf32::find(U"abcdef", U"", -7), 0);
	check_equal(pystring_utf32::find(U"abcdef", U"def"), 3);
	check_equal(pystring_utf32::find(U"abcdef", U"def", 3), 3);
	check_equal(pystring_utf32::find(U"abcdef", U"def", 4), -1);
	check_equal(pystring_utf32::find(U"abcdef", U"def", -5), 3);
	check_equal(pystring_utf32::find(U"abcdef", U"def", -1), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", -2), 7);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", -1), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 0), 1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 1), 1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 2), 4);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4), 4);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 7), 7);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4, 3), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4, 4), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4, 5), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4, -1), 4);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 4, 6), 4);
	check_equal(pystring_utf32::find(U"abcabcabc", U"bc", 0, 0), -1);
	check_equal(pystring_utf32::find(U"abcabcabc", U"", 0, 0), 0);
	check_equal(pystring_utf32::find(U"abcabcabc", U"", 1, 0), -1);
	//rfind()
	check_equal(pystring_utf32::rfind(U"", U""), 0);
	check_equal(pystring_utf32::rfind(U"", U"a"), -1);
	check_equal(pystring_utf32::rfind(U"a", U""), 1);
	check_equal(pystring_utf32::rfind(U"a", U"a"), 0);
	check_equal(pystring_utf32::rfind(U"abcdef", U""), 6);
	check_equal(pystring_utf32::rfind(U"abcdef", U"", 0, 1), 1);
	check_equal(pystring_utf32::rfind(U"abcdef", U"", 0, 5), 5);
	check_equal(pystring_utf32::rfind(U"abcdef", U"", 0, -1), 5);
	check_equal(pystring_utf32::rfind(U"abcdef", U"", 0, -3), 3);
	check_equal(pystring_utf32::rfind(U"abcdef", U"def"), 3);
	check_equal(pystring_utf32::rfind(U"abcdef", U"def", 3), 3);
	check_equal(pystring_utf32::rfind(U"abcdef", U"def", 4), -1);
	check_equal(pystring_utf32::rfind(U"abcdef", U"def", -5), 3);
	check_equal(pystring_utf32::rfind(U"abcdef", U"def", -1), -1);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", -2), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", -1), -1);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 0), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 1), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 4), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 7), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 4, -5), -1);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 4, -10), -1);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"bc", 4, 20), 7);
	check_equal(pystring_utf32::rfind(U"abcabcabc", U"abc", 6, 8), -1);
	//replace
	check_equal(pystring_utf32::replace(U"abcdef", U"foo", U"bar"), U"abcdef");
	check_equal(pystring_utf32::replace(U"abcdef", U"ab", U"cd"), U"cdcdef");
	check_equal(pystring_utf32::replace(U"abcdef", U"ab", U""), U"cdef");
	check_equal(pystring_utf32::replace(U"abcabc", U"ab", U""), U"cc");
	check_equal(pystring_utf32::replace(U"abcdef", U"", U""), U"abcdef");
	check_equal(pystring_utf32::replace(U"abcdef", U"", U"."), U".a.b.c.d.e.f.");
	//join
	std::vector<std::u32string> vec_join{ U"a", U"b", U"c", U"d" };
	check_equal(pystring_utf32::join(U"-", vec_join), U"a-b-c-d");
	vec_join.clear();
	vec_join.push_back(U"a");
	check_equal(pystring_utf32::join(U"-", vec_join), U"a");
	vec_join.clear();
	check_equal(pystring_utf32::join(U"-", vec_join), U"");
	//capitalize()
	check_equal(pystring_utf32::capitalize(U"this IS time test."),U"This is time test.");
	//center()
	check_equal(pystring_utf32::center(U"this", 11, '-'), U"----this---");
	check_equal(pystring_utf32::center(U"hello", 20, '-'), U"-------hello--------");
	//count()
	check_equal(pystring_utf32::count(U"this is string", U"is"), 2);
	//endswith()
	check_equal(pystring_utf32::endswith(U"test.exe", U"exe"), true);
	check_equal(pystring_utf32::endswith(U"test.exe", U"exe", 1, 4), false);
	check_equal(pystring_utf32::endswith(U"", U""), true);
	check_equal(pystring_utf32::endswith(U"", U"a"), false);
	check_equal(pystring_utf32::endswith(U"a", U""), true);
	check_equal(pystring_utf32::endswith(U"", U".mesh"), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh"), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", 0), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", 1), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", 1, 2), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", 1, 1), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", 1, -1), false);
	check_equal(pystring_utf32::endswith(U"help", U".mesh", -1), false);
	check_equal(pystring_utf32::endswith(U".mesh", U".mesh"), true);
	check_equal(pystring_utf32::endswith(U"a.mesh", U".mesh"), true);
	check_equal(pystring_utf32::endswith(U"a.", U"."), true);
	check_equal(pystring_utf32::endswith(U"abcdef", U"ef"), true);
	check_equal(pystring_utf32::endswith(U"abcdef", U"cdef"), true);
	check_equal(pystring_utf32::endswith(U"abcdef", U"cdef", 2), true);
	check_equal(pystring_utf32::endswith(U"abcdef", U"cdef", 3), false);
	check_equal(pystring_utf32::endswith(U"abcdef", U"cdef", 2, 3), false);
	check_equal(pystring_utf32::endswith(U"abcdef", U"cdef", -10), true);
	//startswith
	check_equal(pystring_utf32::startswith(U"", U""), true);
	check_equal(pystring_utf32::startswith(U"", U"a"), false);
	check_equal(pystring_utf32::startswith(U"a", U""), true);
	check_equal(pystring_utf32::startswith(U"abc", U"ab"), true);
	check_equal(pystring_utf32::startswith(U"abc", U"abc"), true);
	check_equal(pystring_utf32::startswith(U"abc", U"abcd"), false);
	check_equal(pystring_utf32::startswith(U"abcdef", U"abc"), true);
	check_equal(pystring_utf32::startswith(U"abcdef", U"abc", 1), false);
	check_equal(pystring_utf32::startswith(U"abcdef", U"bc", 1), true);
	//expandtabs
	check_equal(pystring_utf32::expandtabs(U"\thello\t\r\n", 4),
		U"    hello   \r\n");
	check_equal(pystring_utf32::expandtabs(U"hel\tlo\t\r\n", 8),
		U"hel     lo      \r\n");
	//isalnum
	check_equal(pystring_utf32::isalnum(U"a1"), true);
	check_equal(pystring_utf32::isalnum(U"a1\n"), false);
	check_equal(pystring_utf32::isalnum(U""), false);
	//isalpha
	check_equal(pystring_utf32::isalpha(U"aabc"), true);
	check_equal(pystring_utf32::isalpha(U"a12\n"), false);
	check_equal(pystring_utf32::isalpha(U""), false);
	//isdigit
	check_equal(pystring_utf32::isdigit(U"11"), true);
	check_equal(pystring_utf32::isdigit(U"-11"), false);
	check_equal(pystring_utf32::isdigit(U""), false);
	//islower
	check_equal(pystring_utf32::islower(U""), false);
	check_equal(pystring_utf32::islower(U"11"), false);
	check_equal(pystring_utf32::islower(U"a11"), true);
	//check_equal(pystring_utf32::islower_s(U"a11"), true);
	//isupper
	check_equal(pystring_utf32::isupper(U""), false);
	check_equal(pystring_utf32::isupper(U"11"), false);
	check_equal(pystring_utf32::isupper(U"a11"), false);
	check_equal(pystring_utf32::isupper(U"A11"), true);
	//isspace
	check_equal(pystring_utf32::isspace(U" \r\n\t\f\v"), true);
	check_equal(pystring_utf32::isspace(U" a \r\n\t\f\v"), false);
	check_equal(pystring_utf32::isspace(U""), false);
	//istitle
	check_equal(pystring_utf32::istitle(U""), false);
	check_equal(pystring_utf32::istitle(U"This 1 Is Str1In\nG"), true);
	check_equal(pystring_utf32::istitle(U"this"), false);
	//title
	check_equal(pystring_utf32::title(U""), U"");
	check_equal(pystring_utf32::title(U"this 1 is str1in\ng"),U"This 1 Is Str1In\nG");
	check_equal(pystring_utf32::title(U"this"), U"This");
	//lower
	check_equal(pystring_utf32::lower(U"ThIs"), U"this");
	//upper
	check_equal(pystring_utf32::upper(U"ThIs"), U"THIS");
	//zfill
	check_equal(pystring_utf32::zfill(U"-0.01", 6), U"-00.01");
	check_equal(pystring_utf32::zfill(U"+0.01", 6), U"+00.01");
	//strip
	check_equal(pystring_utf32::strip(U"abccab", U"ab"), U"cc");
	check_equal(pystring_utf32::strip(U""), U"");
	check_equal(pystring_utf32::strip(U"a"), U"a");
	check_equal(pystring_utf32::strip(U"a "), U"a");
	check_equal(pystring_utf32::strip(U" a"), U"a");
	check_equal(pystring_utf32::strip(U"\n a "), U"a");
	check_equal(pystring_utf32::strip(U"\r\n a \r\n"), U"a");
	check_equal(pystring_utf32::strip(U"\r\n a \r\n\t"), U"a");
	//lstrip
	check_equal(pystring_utf32::lstrip(U""), U"");
	check_equal(pystring_utf32::lstrip(U"a"), U"a");
	check_equal(pystring_utf32::lstrip(U"a "), U"a ");
	check_equal(pystring_utf32::lstrip(U" a"), U"a");
	//rstrip
	check_equal(pystring_utf32::rstrip(U""), U"");
	check_equal(pystring_utf32::rstrip(U"a"), U"a");
	check_equal(pystring_utf32::rstrip(U"a "), U"a");
	check_equal(pystring_utf32::rstrip(U" a"), U" a");
	//splitlines
	std::vector<std::u32string> vec_line;
	check_equal(pystring_utf32::splitlines(U"1\n2\n3\n", false),
	...
	check_equal(pystring_utf32::splitlines(U"1\r\n2\r\n3\r\n", true),
		std::vector<std::u32string> { U"1\r\n", U"2\r\n", U"3\r\n" });
	check_equal(pystring_utf32::splitlines(U"\r1\r2\r3", false),
		std::vector<std::u32string> {U"", U"1", U"2", U"3"});
	check_equal(pystring_utf32::splitlines(U"\r1\r2\r3\r", true),
		std::vector<std::u32string> { U"\r", U"1\r", U"2\r", U"3\r" });
	//split
	check_equal(pystring_utf32::split(U"a,,b,,c", U",,"),
		std::vector<std::u32string> {U"a", U"b", U"c"});
	check_equal(pystring_utf32::split(U"\nab c\r"), std::vector<std::u32string> {U"ab", U"c"});
	check_equal(pystring_utf32::split(U"", U"/", 1), std::vector<std::u32string> {U""});
	check_equal(pystring_utf32::split(U" ", U" ", 1), std::vector<std::u32string> {U"", U""});
	check_equal(pystring_utf32::split(U"a ", U" ", 1),
		std::vector<std::u32string> {U"a", U""});
	check_equal(pystring_utf32::split(U"/", U"/", 1), std::vector<std::u32string> {U"", U""});
	check_equal(pystring_utf32::split(U" /", U"/", 1), std::vector<std::u32string> {U" ", U""});
	check_equal(pystring_utf32::split(U" //", U"/", 1), std::vector<std::u32string> {U" ", U"/"});
	check_equal(pystring_utf32::split(U"//as//rew//gdf", U"//"),
		std::vector<std::u32string> {U"", U"as", U"rew", U"gdf"});
	check_equal(pystring_utf32::split(U"/root/world", U"/", 0),
		std::vector<std::u32string> {U"/root/world"});
	check_equal(pystring_utf32::split(U"/root/world", U"/", 1),
		std::vector<std::u32string> {U"", U"root/world"});
	check_equal(pystring_utf32::split(U"/root/world", U"/", 2),
	...
	check_equal(pystring_utf32::split(U"", U"/", 1), std::vector<std::u32string> {U""});
	// U" ".rsplit(None, 1)
	check_equal(pystring_utf32::rsplit(U" ", U"", 1).size(), 0);
	check_equal(pystring_utf32::rsplit(U"  ", U"", 1).size(), 0);
	check_equal(pystring_utf32::rsplit(U" /", U"/", 1), std::vector<std::u32string> {U" ", U""});
	check_equal(pystring_utf32::rsplit(U" //", U"/", 1),
		std::vector<std::u32string> {U" /", U""});
	check_equal(pystring_utf32::rsplit(U"/root", U"/", 1),
		std::vector<std::u32string> {U"", U"root"});
	check_equal(pystring_utf32::rsplit(U"/root", U"/", 0),
		std::vector<std::u32string> {U"/root"});
	check_equal(pystring_utf32::rsplit(U"/root/world", U"/", 1),
		std::vector<std::u32string> {U"/root", U"world"});
	check_equal(pystring_utf32::rsplit(U"/root/world", U"/", 2),
		std::vector<std::u32string> {U"", U"root", U"world"});
	check_equal(pystring_utf32::rsplit(U"/root/world", U"/", -1),
		std::vector<std::u32string> {U"", U"root", U"world"});
	// U" root world".rsplit(None, 0)
	check_equal(pystring_utf32::rsplit(U" root world"), std::vector<std::u32string> {U"root", U"world"});
	check_equal(pystring_utf32::rsplit(U" root world", U" ", 0),
		std::vector<std::u32string> {U" root world"});
	check_equal(pystring_utf32::rsplit(U" root world", U" ", 1),
		std::vector<std::u32string> {U" root", U"world"});
	check_equal(pystring_utf32::rsplit(U" root world", U" ", 2),
		std::vector<std::u32string> {U"", U"root", U"world"});
	//format
	check_equal(pystring_utf32::format(U"{} + {} = {}", std::vector<std::u32string>{U"1", U"2", U"3"}), U"1 + 2 = 3");
	check_equal(pystring_utf32::format(U"{2} + {1} = {0}", std::vector<std::u32string>{U"5", U"2", U"3"}), U"3 + 2 = 5");
	//between_start_and_end_string 并非python函数
	check_equal(pystring_utf32::between_start_and_end_string(U"test@example.com", U"@"), U"example.com");
	check_equal(pystring_utf32::between_start_and_end_string(U"From: test <test@example.com>", U"<", U">"), U"test@example.com");
