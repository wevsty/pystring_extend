...
#pragma once
#endif
#ifndef __PYTHON_UTF32_STRING_FUNCTION_TEMPLATE_H__
#define __PYTHON_UTF32_STRING_FUNCTION_TEMPLATE_H__
...
namespace pystring_utf32_function
{
	...
	void split_whitespace(
		TEMPLATE_VECTOR_STRING &vec_output, const std::u32string &str,
		long_max_t maxsplit)
	{
		vec_output.clear();
		size_t i;
	...
	void join(const std::u32string &str,
	...
	template <typename TEMPLATE_VECTOR_STRING>
	void format(std::u32string format_str,
		TEMPLATE_VECTOR_STRING vec_format_list, std::u32string &str_output)
	{
...
#endif //__PYTHON_UTF32_STRING_FUNCTION_TEMPLATE_H__
